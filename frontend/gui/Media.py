from tkinter import Frame, Label, font, LEFT, RIGHT, Y, BOTH
from PIL import ImageTk, Image
from .GUIComponent import GUIComponent
from exceptions import MissingProperty


class Media(Frame, GUIComponent):
    @classmethod
    ...
    def init_components(self, cover_movie=True, *args, **kwargs):
        ...
        rating_label = Label(self, text=self._props["rating"], font=Media.RATING_FONT)
        rating_label.pack(side=RIGHT, padx=5)
